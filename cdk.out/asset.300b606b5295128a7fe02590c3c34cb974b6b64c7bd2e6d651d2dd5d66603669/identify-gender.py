            ...
            "messages": [
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": "What is the gender of the person in the picture? Only return output as JSON without explanation in the following format { \"gender\": <gender>, \"probablity\": <probability> }. Example { \"gender\": \"female\", \"probablity\": \"85%\" }"
                        }
                    ]
                }
            ],
