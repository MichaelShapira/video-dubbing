            ...
            "messages": [
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": "What is the probablity of the person in the picture to be male or female? Only return output as JSON without explanation in the following format { \"gender\": <gender>, \"probablity\": <probability> }. Example { \"gender\": \"female\", \"probablity\": \"85%\" }"
                        }
                    ]
                }
            ],
